...
int main(int argc, char** argv) {
	...
	glutAddMenuEntry("13. FilledRectangles",13);
	glutAddMenuEntry("14. Crop",14);
	glutAddMenuEntry("15. To Grayscale",15);
	glutAddMenuEntry("16. To Color",16);	
	glutAddMenuEntry("17. Save Image",17);
	glutAddMenuEntry("18. Increase Contrast",18);
	glutAddMenuEntry("19. Reduce Contrast",19);
